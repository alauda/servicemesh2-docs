...
- Gateway API CRDs are installed at bundle version `v1.5.x`, which Istio 1.30 requires. For more information, see [Gateway API CRD requirements](../../updating/update-mesh/index.mdx#gateway-api-crd-requirements).
...
16. *Optional* : Deploy the gateway to <ExternalSiteLink name="acp" href="/configure/clusters/acp-node-planning.html" children="Infra Nodes" />:
