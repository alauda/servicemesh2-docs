...
<Steps>
  ...
  If the command returns an empty output, try using `kubectl -n cpaas-system get secret dex.tls -o jsonpath='{.data.tls\.crt}'` or contact your administrator to obtain the ACP CA certificate.
  </Directive>
