...
1. Check available versions
    ...
    **Example output**
    ...
    stable   kiali-operator.v2.27.1-rc.0  2.27.1-rc.0
    ```
...
4. Create a Subscription
    ...
    spec:
      ...
      startingCSV: kiali-operator.v2.27.1-rc.0
    EOF
    ```
...
6. Approve InstallPlan
    ...
    **Example output**
    ...
    install-ddh84   kiali-operator.v2.27.1-rc.0   Manual     false
    ```
...
kiali-operator.v2.27.1-rc.0   Alauda Build of Kiali   2.27.1-rc.0              Succeeded
```
...
<Steps>
  ...
  **Example output:**
  ...
  <Callouts>
    ...
    11. Required in multi cluster mesh. `<mesh_id>` should be the same as the `.spec.values.global.meshId` in `Istio` resource.
