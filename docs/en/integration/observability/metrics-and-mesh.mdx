...
You can integrate Alauda Service Mesh with monitoring to enable observability in your service mesh. Monitoring provides access to essential built-in tools and is required to run Kiali, the dedicated console for Istio.
