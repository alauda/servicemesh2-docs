...
- kube-ovn is v4.1.5 or later and uses overlay networking. Ambient mode does not work on a kube-ovn underlay network; see [Ambient mode is not supported on kube-ovn underlay networks](../../about/release-notes/alauda-service-mesh-v2.1-known-issues.mdx#ambient-mode-requires-kube-ovn-overlay).
