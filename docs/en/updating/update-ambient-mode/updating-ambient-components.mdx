...
3. Confirm that the control plane reports the new version:
    ...
    **Example output**
    ...
    default   istio-system   ambient   1           1       1        default           Healthy   v1.28.6   12m
    ```
...
4. Confirm that the ZTunnel proxy reports the new version:
    ...
    **Example output**
    ...
    ```text
    NAME      NAMESPACE   PROFILE   READY   STATUS    VERSION   AGE
    default   ztunnel     ambient   True    Healthy   v1.28.6   18m
    ```
...
5. Inspect the per-node ZTunnel pods:
    ...
    **Example output**
    ...
    ztunnel-4xrhj   1/1     Running   0          2m11s   10.3.0.152   192.168.131.32
    ztunnel-9kt5n   1/1     Running   0          3m02s   10.3.1.78    192.168.131.33
    ```
