...
- If you use the Kubernetes Gateway API, you have upgraded the Gateway API CRDs to bundle version `v1.5.x`. For more information, see [Gateway API CRD requirements](../update-mesh/index.mdx#gateway-api-crd-requirements).
