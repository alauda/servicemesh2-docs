...
:::warning
Istio 1.30 requires Kubernetes 1.32 or later. Before you update the control plane to Istio 1.30, verify that the cluster meets this requirement and review the [compatibility and support matrix](../../about/release-notes/compatibility-support-matrix.mdx).
:::
