...
3.  Get the `ZTunnel` resource name by executing this command:
    ...
    **Example output**
    ...
    default   ztunnel     True    Healthy   v1.30.4   1d
    ```
...
1.  Get the `Istio` resource name by executing this command:
    ...
    **Example output**
    ...
    <name_of_custom_resource>  istio-system   ambient   1           1       1        default           ZTunnelNotFound   v1.30.4   1d
    ```
...
1.  Get the `IstioCNI` resource by executing this command:
    ...
    **Example output**
    ...
    default   istio-cni   ambient   True    Healthy   v1.30.4   1d
    ```
