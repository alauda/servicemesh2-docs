...
- kube-ovn must be v4.1.5 or later and must use overlay networking. Ambient mode does not work on a kube-ovn underlay network; see [Ambient mode does not work on a kube-ovn underlay network](../../about/release-notes/alauda-service-mesh-v2.2-known-issues.mdx#ambient-mode-requires-kube-ovn-overlay).
