...
:::note
[Namespace requirements](../installing-service-mesh/application-deployment/namespace-requirements.mdx) and [Application Requirements](../installing-service-mesh/application-deployment/application-requirements.mdx).
:::
