...
For instance, using the example revision `default-v1-28-6` from above, the following labels would enable sidecar injection:

| **Resource** | **Enabled label**              | **Disabled label**              |
| ------------ | ------------------------------ | ------------------------------- |
| Namespace    | `istio.io/rev=default-v1-28-6` | `istio-injection=disabled`      |
| Pod          | `istio.io/rev=default-v1-28-6` | `sidecar.istio.io/inject=false` |
