...
default-v1-28-1   istio-system             True    Healthy   False    v1.28.1   40s
```
...
| ------------ | ------------------------------ | ------------------------------- |
| Namespace    | `istio.io/rev=default-v1-28-1` | `istio-injection=disabled`      |
| Pod          | `istio.io/rev=default-v1-28-1` | `sidecar.istio.io/inject=false` |
