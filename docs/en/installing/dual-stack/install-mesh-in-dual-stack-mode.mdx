...
- `sleep`: hosts the client application for sending test requests.
   ...
   kubectl label namespace dual-stack pod-security.kubernetes.io/enforce=restricted
   kubectl create namespace ipv4
   kubectl label namespace ipv4 pod-security.kubernetes.io/enforce=restricted
   kubectl create namespace ipv6
   kubectl label namespace ipv6 pod-security.kubernetes.io/enforce=restricted
   kubectl create namespace sleep
   kubectl label namespace sleep pod-security.kubernetes.io/enforce=restricted
   ```
