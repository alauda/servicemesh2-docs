...
For a complete list of available configuration for the values field, refer to [sail-operator's documentation](https://github.com/alauda-mesh/sail-operator/blob/release-2.2/docs/api-reference/sailoperator.io.md).
